...
public class SingleStarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // We store it in Redis so all star pods share the same state.
        // Because state is externalized to Redis, ingress does not need sticky sessions.
        // Requests can be load-balanced across star pods (round-robin style) safely.
        ...
        String redisKey = "accessCount:" + username;
        // incr(accessCount:<username>): global per-user counter shared by all star pods.
        long accessCount = RedisUtil.increment(redisKey);
